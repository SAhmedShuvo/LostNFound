...
const ItemDetails = ({ params })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ItemDetails.useEffect": ()=>{
            const fetchItem = {
                "ItemDetails.useEffect.fetchItem": async ()=>{
                    try {
            ...
            }["ItemDetails.useEffect.fetchItem"];
            fetchItem();
        }
    }["ItemDetails.useEffect"], [
        id
...
_s(ItemDetails, "1slAUbL6B2occ+ymR82gbrSVKDM=");
_c = ItemDetails;
...
//# sourceMappingURL=my-app_6493a7fa._.js.map