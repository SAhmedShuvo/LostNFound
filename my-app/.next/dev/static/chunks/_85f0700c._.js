...
const ClaimItemPage = ({ params })=>{
    _s();
    const { id } = params;
    const item = __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$lostitem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["lostItems"].find((it)=>it.id == id) || __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$2f$founditem$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["foundItems"].find((it)=>it.id == id);
...
_s(ClaimItemPage, "QRpM4Ox0fW7TaLwpINiAMPyrs+o=");
_c = ClaimItemPage;
...
//# sourceMappingURL=_85f0700c._.js.map